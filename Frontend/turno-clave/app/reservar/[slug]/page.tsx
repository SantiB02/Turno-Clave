...
export default async function Reserva({ params }: Props) {
  const { slug } = await params

  let business: PublicBusinessDetail | null = null
    ...
    <div className="m-4">
      ...
      <div className=" mt-10 flex flex-col items-center justify-center">
        <div>
          ...
          <p className="text-lg text-center">De forma rápida y sencilla</p>
        </div>
      </div>

      <div className="flex justify-center my-4">
        <Button
          href={`/reservar/${slug}/servicios`}
          className="px-6"
          label="Sacar turno"
          size="text-2xl"
