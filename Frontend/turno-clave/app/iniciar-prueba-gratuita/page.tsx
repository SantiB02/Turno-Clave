      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Descubre cómo Turno Clave puede transformar la gestión de tus turnos
            con nuestra prueba gratuita de 14 días. Sin compromiso, sin tarjeta
            de crédito.
          </p>
        </div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Notificaciones automáticas para reducir ausencias y mantener
                    a tus clientes informados
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
